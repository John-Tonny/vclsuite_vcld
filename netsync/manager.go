...
import (
	...
	peerpkg "github.com/John-Tonny/vclsuite_vcld/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*vclutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *vclutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *vclutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *vclutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
