...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr vclutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*vclutil.Tx, error) {
...
func CreateBlock(prevBlock *vclutil.Block, inclusionTxs []*vclutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr vclutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*vclutil.Block, error) {
	...
	blockTxns := []*vclutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := vclutil.NewBlock(&block)
