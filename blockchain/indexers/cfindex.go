...
func storeFilter(dbTx database.Tx, block *vclutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *vclutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *vclutil.Block,
