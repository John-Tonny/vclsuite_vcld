...
func (view *UtxoViewpoint) AddTxOut(tx *vclutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *vclutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *vclutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *vclutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *vclutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *vclutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *vclutil.Tx) (*UtxoViewpoint, error) {
