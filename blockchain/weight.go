...
func GetBlockWeight(blk *vclutil.Block) int64 {
...
func GetTransactionWeight(tx *vclutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *vclutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
